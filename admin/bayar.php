...
if ($aksi == 'bayar') {
    ...
    $up = $dbo->update("orders", "total = '$total', diskon = '$diskon', pajak = '$pajak', bayar='$bayar', kembali = '$kembalian'", "idorder=" . $_GET['idorder']);
    if ($up) {
        echo "<script>alert('Pembayaran Berhasil');location.href='?hal=transaksi';</script>";
    }
}
?>
<div class="judul">
...
?>
<div class="data">
    <table style="width: 60%; margin: auto; margin-top: 100px;" cellpadding="0" cellspacing="0">
        <tr>
            <th>No</th>
            <th>Nama Menu</th>
            <th>Jumlah</th>
        ...
        <form method="post" action="?hal=bayar&aksi=bayar&idorder=<?= $id ?>">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <button onclick="histroy.back();">Batal</button>
                </td>
                <td>
